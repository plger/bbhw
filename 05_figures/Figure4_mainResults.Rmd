...
levels(st$score) <- gsub("^FDR$", "Standard (no prior)", levels(st$score))
p1 <- tprPlot(st)
...
pdf("Figure4_main.pdf", width=10, height=13)
plot_grid( p1, pt1, pt2,
           nrow=3, rel_heights = c(4.6,3,3.5), labels=LETTERS[1:3], scale=0.95)
dev.off()
```
